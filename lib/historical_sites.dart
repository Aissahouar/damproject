...
class VisitPlacesScreen2 extends StatefulWidget {
  @override
  _VisitPlacesScreenState createState() => _VisitPlacesScreenState();
}

class _VisitPlacesScreenState extends State<VisitPlacesScreen2> {
  final List<Place> places = [
    Place(
      title: 'Tassili',
      description: 'Description for Place 1.',
      imageUrl: 'assets/tassili.jpeg',
      comments: ['Nice place!', 'Beautiful view.'],
    ),
    Place(
      title: 'Tipaza',
      description: 'Description for Place 2.',
      imageUrl: 'assets/tipaza.jpeg',
      comments: ['Amazing!', 'I want to visit.'],
    ),
    Place(
      title: 'Belabbas',
      description: 'Description for Place 2.',
      imageUrl: 'assets/belabbas.jpeg',
      comments: ['Wow'],
    ),
    Place(
      title: 'Constantine',
      description: 'Description for Place 2.',
      imageUrl: 'assets/amir.jpeg',
...
class CommentButton extends StatelessWidget {
  ...
  const CommentButton({required this.commentCount, required this.onCommented});
